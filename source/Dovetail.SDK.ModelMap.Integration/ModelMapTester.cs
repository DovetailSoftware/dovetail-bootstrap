...
using BeginRelation = Dovetail.SDK.ModelMap.Instructions.BeginRelation;
using EndRelation = Dovetail.SDK.ModelMap.Instructions.EndRelation;
...
namespace Dovetail.SDK.ModelMap.Integration
{
	...
	public class ModelMapTester
	{
		...
		private class RecordingVisitor : IModelMapVisitor
		{
		...
		{
			public List<ModelMap> TheMaps = new List<ModelMap>();
			public List<ModelMap> ThePartials = new List<ModelMap>();
