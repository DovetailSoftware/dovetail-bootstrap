...
namespace Dovetail.SDK.Bootstrap.Tests.Clarify
{
	...
	[TestFixture, Explicit]
	public class handling_race_conditions_of_ejecting_and_getting
	{
		private InMemoryClarifyApplication theApplication;
		private ClarifySessionCache theCache;
		private ObjectMother theData;
		private string theEmployee;
		private Guid theSessionId;
	...
	public class NulloSessionConfigurator : IUserClarifySessionConfigurator
	{
	...
	public class SessionStartObserver : IUserSessionStartObserver
	{
	...
	public class SessionEndObserver : IUserSessionEndObserver
	{
	...
	public class InMemoryClarifyApplication : IClarifyApplication
	{
