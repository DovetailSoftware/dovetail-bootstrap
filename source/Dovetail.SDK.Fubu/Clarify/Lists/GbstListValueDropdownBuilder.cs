...
{
	public class GbstListValueDropdownBuilder : ElementTagBuilder
	{
		public override bool Matches(ElementRequest elementRequest)
		{
			return elementRequest.Accessor.HasAttribute<GbstListValueAttribute>();
		}
